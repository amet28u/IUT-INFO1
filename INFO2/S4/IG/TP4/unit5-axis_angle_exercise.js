...
function fillScene() {
	...
	var rotationAxis1 = new THREE.Vector3(1,0,-1);
	...
	cylinder1.matrix.makeRotationAxis( rotationAxis1, theta );
	scene.add( cylinder1 );

	var cylinder2 = new THREE.Mesh(
		new THREE.CylinderGeometry( 0.2, 0.2, cylLength, 32 ), cylinderMaterial );
	var rotationAxis2 = new THREE.Vector3(-1,0,1);
	// makeRotationAxis wants its axis normalized
	...
	var cylinder3 = new THREE.Mesh(
		new THREE.CylinderGeometry( 0.2, 0.2, cylLength, 32 ), cylinderMaterial );
	var rotationAxis3 = new THREE.Vector3(-1,0,-1);
	// makeRotationAxis wants its axis normalized
	...
	var cylinder4 = new THREE.Mesh(
		new THREE.CylinderGeometry( 0.2, 0.2, cylLength, 32 ), cylinderMaterial );
	var rotationAxis4 = new THREE.Vector3(1,0,1);
	// makeRotationAxis wants its axis normalized
