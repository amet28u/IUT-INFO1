...
function fillScene() {
	...
	// base
	cube = new THREE.Mesh(
		new THREE.CubeGeometry( 20+64+110, 4, 2*77+12  ), footMaterial );
	...
	// legs
	cube = new THREE.Mesh(
		new THREE.CubeGeometry( 60, 282+4, 4  ), legMaterial );
	cube.position.x = 0;	// centered on origin along X
...
function render() {
	...
	light.position.set(Math.cos(effectController.azimuth*Math.PI/180),
										 Math.tan(effectController.altitude*Math.PI/180),
	 									 Math.sin(effectController.azimuth*Math.PI/180));
